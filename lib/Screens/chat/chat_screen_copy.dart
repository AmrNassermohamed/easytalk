...
//  bool isKeyboardVisible = false;
                                                    ...
                                                    Column(  crossAxisAlignment:
                                                      ...
                                                      validationService
                                                        ...
                                                        ? CrossAxisAlignment.end : CrossAxisAlignment.start,children: [
                                                         ...
                                                         MessageComponents(index: index,checkMessage: true,user1: widget.user1,),

                                             /*  validationService.settingLang==false ||validationService.settingLang==true&&validationService.messageList[index].type!="image"?GestureDetector(onTap: () async {
 ...
 child: Padding(padding: EdgeInsets.all(10),child: Image.asset("assests/Iconmaterial-translate.png",width: 40,height: 20,),),
                                          ...
                                          [Expanded(child:  message(index,false))],):SizedBox(height: 0,),*/
                                                      validationService.messageList[index].type !="text"?     Row( mainAxisAlignment:
